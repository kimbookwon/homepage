...
public class ImgTest {
	...
	private static void checkemail(ImgDAO dao) {
	...
	private static void upPasswd(ImgDAO dao) {
		Map map = new HashMap();
		map.put("id", "admin");
		map.put("passwd", "1234");
		if(dao.updatePw(map)) {
	...
	private static void checkid(ImgDAO dao) {
	...
	private static void readPasswd(ImgDAO dao) {
	...
	private static void passwdcheck(ImgDAO dao) {
		Map map = new HashMap();
		map.put("id", "admin");
		map.put("passwd", "1234");
