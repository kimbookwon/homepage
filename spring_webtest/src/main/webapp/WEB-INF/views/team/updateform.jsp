...
<%
//	TeamDTO dto = (TeamDTO)request.getAttribute("dto");
%>
...
<table class="table table-bordered">
	...
	<c:if test="${fn:indexOf(dto.skills,'Java')!=-1 }">
	checked
	</c:if>
		
	>java</label>
	<label><input type="checkbox" name="skills" value="JSP"
	<c:if test="${fn:indexOf(dto.skills,'JSP')!=-1 }">
	checked
	</c:if>
	>JSP</label>
	<label><input type="checkbox" name="skills" value="MVC"
	<c:if test="${fn:indexOf(dto.skills,'MVC')!=-1 }">
	checked
	</c:if>
	>MVC</label>
	<label><input type="checkbox" name="skills" value="Spring"
	<c:if test="${fn:indexOf(dto.skills,'Spring')!=-1 }">
	checked
	</c:if>
	>Spring</label>
	<label><input type="checkbox" name="skills" value="Ajax"
	<c:if test="${fn:indexOf(dto.skills,'Ajax')!=-1 }">
	checked
	</c:if>
	>Ajax</label>
	<!-- 체크박스의 값을 그대로 불러온다. -1일경우 -->
	</td>
	</tr>
	<tr>
		<th>취미</th>
	...
	<tr>
		...
		id="sample6_address" value="${dto.address }"> 
...
<div>
	...
	<button onclick="reset()">입력 취소</button>
</div>
<input type="hidden" name="no" value="${param.no }">
</form>
