...
<table class="table">
  <tr>
    <td class="td">
        <img src="${root}/images/spring.jpg" width= "100%" height="100%">
    </td>
  </tr>
...
<li class="nav-item dropdown">
  ...
  <li class="nav-item dropdown">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item" href="${root}/image/create">이미지 등록</a>
      <a class="dropdown-item" href="${root}/image/list">이미지 목록</a>
    </div>
  </li>

   <c:choose>
   	<c:when test="${empty id}">
   	  <li class="nav-item"><a class="nav-link" href="${root}/member/agreement">Sign Up</a></li>
